                            ...
                            <div className='flex justify-between'>
                                <div className="mt-6 flex items-center justify-between">
                                    <Link
                                        to="/login"
                                    >
                                        <p className='flex items-center gap-x-2 hover:to-blue-500 text-black font-semibold'>
                                            <BiArrowBack />
                                            Back to Login
                                        </p>
                                    </Link>
                                ...
                                {/* <p className="text-sm text-gray-600 mt-2 text-right">
                                    Didn’t get the OTP? Please check your <span className="font-semibold">Spam</span> or <span className="font-semibold">Junk</span> folder and mark the email as <span className="font-semibold">"Not Spam"</span> if you find it there.
                                </p> */}
